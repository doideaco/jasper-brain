...
name: Brand Voice
sku: JSP-BV
description: Capture, codify, and apply your brand voice across every piece of content your team produces.
audience: Marketing leaders responsible for brand consistency across a distributed content team or agency network.
tags: [product, brand, voice]
valueProps:
  - Stop rewriting briefs to explain "what we sound like."
  - One source of truth that every writer, agency, and AI tool pulls from.
  - Brand drift dies the moment voice becomes infrastructure.
features:
  - name: Voice capture
    description: Upload sample content and Jasper distills tone, vocabulary, and structural patterns into a reusable voice profile.
